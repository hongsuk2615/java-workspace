package com.kh.chapter01_network.server.run;

import com.kh.chapter01_network.server.tcp.Server;

public class Run {
	/*
	 * TCP (Transmission Control Protocol)
	 * - 서버, 클라이언트 간의 1:1 소켓 통신
	 * - 데이터를 교환하기에 앞서서 서버, 클라이언트 연결되어있어야함(서버가 먼저 실행되면서 클라이언트의 요청을 기다림)
	 * - 신뢰성 있는 데이터 전달가능
	 * 
	 * ServerSocket
	 ...
	 * - 메서드
	 *  > OutputStream out = client.getOutputStream() 메서드를 통해 데이터를 내보낼수있는 출력스트림을 생성.
