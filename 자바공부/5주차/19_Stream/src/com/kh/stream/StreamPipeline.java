...
public class StreamPipeline {
	 ...
	 * 최종처리 스트림 역할 : 중간 처리 스트림의 값을 토대로 결과값 반환(sum,min,....)
	 * 
	 */
	public static void main(String[] args) {
		...
		//삼성제품의 평균가격 구하기
		//Stream<Product> averagePrice = pList.stream();
		double averagePrice = pList.stream().
		...
		System.out.println("삼성제품의 평균가격은 "+averagePrice+"원 입니다.");
