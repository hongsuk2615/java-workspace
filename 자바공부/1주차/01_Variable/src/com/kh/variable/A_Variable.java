...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("고길동 :" + (pay*time*day) + "원 입니다.");
	...
	public void declareVariable() {
		 ...
		 * 
		 * 3. 해당 영역에 선언된 변수는 해당 영역안에서만 사용 가능(다른 메소드에서는 불가능.) => 지역변수라는 개념
		 */
		...
		double dNum; // 8byte => 소수점아래 15자리까지 표현가능 (실수 대표자료형)
		...
		sNum = 2;
		iNum = 4;
		lNum = 8L;   // L은 long 자료형임을 알려주기 위함
		
		fNum = 4.0f; // 반드시 f를 붙여 줘야함
		dNum = 8.0;
		
		ch = 'A';    // 반드시 ''(작은 따옴표)안에 넣어야함
		str = "abc"; // 반드시 ""(큰 따옴표)안에 넣어야함
