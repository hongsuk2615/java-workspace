...
//import java.lang.*
//생략가능,보이진 않지만 항상 자동으로 java.lang 패키지가 import 돼있음
public class MathRun {

	public static void main(String[] args) {
		
		//Math 클래스(수학과 관련된 기능을 제공하고있음)
		...
		double num1 = 4.349;
		System.out.println("num1 올림: " + Math.ceil(num1));
			
		//반올림 =>Math.round(double) : 반환값이 long임
		 ...
		 * -모든 메서드 => static 메서드
		 * 
		 * 모든 게 다 static이기 때문에 Math.필드 or Math.메서드명 으로 다 접근가능(객체생성할 필요가 없음)
		 * Math클래스의 생성자가 private이다.(객체 생성불가)
		 * 
		 * 
		 * 
		 * 
