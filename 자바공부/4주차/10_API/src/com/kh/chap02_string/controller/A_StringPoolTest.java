package com.kh.chap02_string.controller;
	...
	//수정하는 순간 기존의 값이 담겨있는 공간에서 수정되지않음.
public class A_StringPoolTest {
	...
	public void method1() {
		...
		//String 클래스의hashCode()메서드의 경우 주소값 기반이 아닌 실제 담긴 문자열 기반으로 해시코드값을 반환하도록 오버라이딩 되어있음
	...
	public void method3() {
		 ...
		 * 불변이라고 해서 수정이 아예안되는게 아니라
		 * 기존의 그 자리(원래있던 주솟값)에서 수정되는 개념이 아니라는 것.
		 * 매번 새로운 주소값을 참조하게 됨.
		 * 
		 */
	}
