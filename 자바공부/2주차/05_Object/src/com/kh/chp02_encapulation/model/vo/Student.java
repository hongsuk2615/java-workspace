package com.kh.chp02_encapulation.model.vo;
...
public class Student {
	...
	// 해당필드에 대입하고자하는 값을 전달받아 해당필드에 대입시켜주느 기능의 메소드
	...
	public void setName(String name) {
		...
		// 왜? 필드명과 매개변수명이 동일한경우 {}영역 내에서는 해당영역에서 만들어진 변수가 좀더 우선순위가 높기때문.
	...
	public String getName() {// void : 반환하는 값이 없을경우에 작성
		return name; // return 반환값; -> 반환값을 나를호출한 메서드의 위치에 전달하겠다.
	}
