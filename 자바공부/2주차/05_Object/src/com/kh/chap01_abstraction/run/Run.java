...
public class Run {
	 ...
	 * 
	 * 2. 객체란 ? 사전적 의미로는 현실세계에 독립적으로존재하는 모든것을 의미
	 * 
	 ...
	 *             만약 학생 "건강"을 관리하는 프로그램이라면 ? 이름,키,학년,반,몸무게,머기만 추려낸다.
	 ...
	 *             								=> String name3 = ...;
	 *             => 관리하고자하느 학생들이 늘어나면 늘어날수록 생성해야할 갯수도 엄청나게 증가하게됨 . 즉 관리하기가 굉장히 힘듬.
	 *             
	 ...
	 *             학생들의 키를 보관하는 배열 선언   => double[] height = {123.1,173.5,144,6};
	 *             => 변수를 사용하는 것보다는 나아보임.
	...
	public static void main(String[] args) {
		...
		hong.name = "홍길동";
		hong.age = 20;
		hong.height = 166.7; //필드 접근하고자한다면 .을통해 가져올수있음(단, 접근제한자가 public인경우)
		 ...
		 * => 외부에서 함부러 값을 변질시키거나 조회권한이 없는 사람이 값ㅇ르 쉽게 가져올수 있는 문제발생
		 * >>> 캡슐화로 해결.
